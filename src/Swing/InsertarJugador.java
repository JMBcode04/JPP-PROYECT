...
public class InsertarJugador extends javax.swing.JFrame {
    ...
    InsertarJugador(SubmenuGestionJugadores aThis, boolean b) {
    ...
    private void initComponents() {
        ...
        NombreLBL.setText("Insertar Nombre");
        ...
        NombreLBL1.setText("Insertar Nombra");

        apellidotxt.setText("Nombre");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        /*if(!NombreTXT.getText().equalsIgnoreCase("nombre") && !apellidotxt.getText().equalsIgnoreCase("apellido")){
